    ...
    <footer className="bg-secondary text-white">
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-gray-300 mt-4">
              Des solutions digitales innovantes pour propulser votre entreprise vers l'avenir.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#services" className="text-gray-300 hover:text-white transition-colors">Applications Mobile</a></li>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">&copy; {new Date().getFullYear()} MarocInnov. Tous droits réservés.</p>
